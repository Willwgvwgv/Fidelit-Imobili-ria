...
export const NAV_ITEMS = [
  ...
  { 
    ...
    subItems: [
      ...
      { id: 'financial-importar-extrato', label: 'Importar Extrato Bancário', icon: <Upload size={18} /> },
